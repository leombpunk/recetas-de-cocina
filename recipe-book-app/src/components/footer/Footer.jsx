                        ...
                        <div class="text-center">
                            ...
                            <div class="flex justify-center my-10">
                                <div class="flex items-center border  rounded-lg px-4 py-2 w-52 mx-2">
                                    <img src="https://cdn-icons-png.flaticon.com/512/888/888857.png" class="w-7 md:w-8" alt="descarga la app desde la play store"/>
                                    <div class="text-left ml-3">
                                        <p class='text-xs text-gray-900'>Descarga</p>
                                        <p class="text-sm md:text-base"> Google Play Store </p>
                                    </div>
                                </div>
                                <div class="flex items-center border  rounded-lg px-4 py-2 w-52 mx-2">
                                    <img src="https://cdn-icons-png.flaticon.com/512/888/888841.png" class="w-7 md:w-8" alt="descarga la app desde la apple store"/>
                                    <div class="text-left ml-3">
                                        <p class='text-xs text-gray-900'>Descarga</p>
