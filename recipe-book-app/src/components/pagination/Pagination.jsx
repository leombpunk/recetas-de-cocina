...
const Pagination = () => { //props tipo: total de paginas, pagina actual
    //limitar el maximo de paginas a mostrar
  return (
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        ...
        <div>
          <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
            ...
            {/* Current: "z-10 bg-indigo-600 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600", Default: "text-gray-900 ring-1 ring-inset ring-gray-700 hover:bg-orange-600 focus:outline-offset-0" */}
            <a
              href="#"
              aria-current="page"
            ...
            <span className="relative inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-700 ring-1 ring-inset ring-gray-700 focus:outline-offset-0">
              ...
            </span>
            <a
              href="#"
