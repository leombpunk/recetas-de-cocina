const Feedback = () => {
  return (
    ...
    <section className='relative w-full bg-orange-400 bg-cover bg-center min-h-[90svh]'>
      ...
      <div className="mx-auto max-w-2xl text-center">
           <h2 className="text-balance text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">Retroalimentación</h2>
           <p className="mt-2 text-xl/8 text-gray-800">Tu opinión y comentarios me ayudan a crecer y mejorar el producto!</p>
         </div>
        <div className='flex flex-col lg:flex-row items-center gap-10 w-full'>
          
          <div
            className='lg:w-1/2 rounded-3xl shadow-md shadow-black/50'
            style={{ backgroundImage: `url(${null})`, backgroundPosition:'center', backgroundSize:"cover" }}
          >
            {" "}
            <img src={null} className='w-full' alt='imagen de chefsito' />
          </div>
          <div className='flex flex-col gap-4 w-full lg:w-1/2'>
            <form className="mt-16 sm:mt-20">
              <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                <div>
                  <label htmlFor="first-name" className="block text-xl/6 font-medium text-gray-900">
                    Nombre (opcional)
                  </label>
                  <div className="mt-2.5">
                    <input
                ...
                <div>
                  <label htmlFor="last-name" className="block text-xl/6 font-medium text-gray-900">
                    Correo electrónico
                  </label>
                  <div className="mt-2.5">
                    <input
                ...
                <div className="sm:col-span-2">
                  <label htmlFor="message" className="block text-xl/6 font-medium text-gray-900">
                    Comentario
                  </label>
                  <div className="mt-2.5">
                    <textarea
