            ...
            <div className='border-b border-gray-900/10 pb-12'>
              ...
              <div className='mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6'>
                <div className='sm:col-span-4'>
                  ...
                  <div className='mt-2'>
                    <div className='flex rounded-md shadow-md ring-1 ring-inset ring-black focus-within:ring-2 focus-within:ring-inset focus-within:ring-orange-600 sm:max-w-md'>
                      <span className='flex select-none items-center pl-3 text-gray-700 sm:text-sm'>
                        cookingbook.dev/
                      </span>
                      <input
                        type='text'
                ...
                {/* <div className='col-span-full'>
                  ...
                  <div className='mt-2'>
                    <textarea
                      ...
                      name='about'
                      rows={3}
                      className='block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:text-sm sm:leading-6'
                      defaultValue={""}
                    />
                  </div>
                ...
                {/* <div className='sm:col-span-3'>
                  ...
                  <div className='mt-2'>
                    <select
                      ...
                      className='block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:max-w-xs sm:text-sm sm:leading-6'
                    >
