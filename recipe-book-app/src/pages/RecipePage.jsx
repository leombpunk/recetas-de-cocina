...
const RecipePage = ({idRecipe}) => {
  ...
  const {recipeData, createRecipe,updateRecipe,deleteRecipe,getRecipe} = useRecipe()
  useEffect(() => {
    saveRecipeLocal(recipeStruct)
  },[])
  return (
    <>
      <section className='bg-orange-300'>
        <div className='mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8'>
          <RecipeForm title="Nueva Receta" handleNotification={addNotification} data={recipeData} />
        </div>
      </section>
    </>
  )
